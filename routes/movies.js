...
const { validateMovieId, validateCreateMovie } = require('../validator');
...
router.put('/:id', isAuthenticated, validateMovieId, validateCreateMovie, validate, moviesController.updateMovie);
